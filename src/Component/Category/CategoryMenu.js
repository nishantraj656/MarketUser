    ...
    _inslized=async()=>{ 
       ...
       let value = await AsyncStorage.getItem('categoryID')
        if(value !=null){
            ...
            let subCategorySQL ="SELECT `subcategory_id`,subcategory_pic, `category_id`, `subcategory_name` FROM `sub_category_table` where category_id="+value;
